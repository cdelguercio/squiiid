...
class SquiiidImage(models.Model):
    ...
    image_compressed = models.ImageField(upload_to='images/', null=True, blank=True)
    image_1_compressed = models.FileField(upload_to='images/', null=True, blank=True)
    image_2_compressed = models.FileField(upload_to='images/', null=True, blank=True)
