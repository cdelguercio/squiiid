...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SquiiidImage.image'
        db.alter_column(u'squiiid_squiiidimage', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'SquiiidImage.image'
        db.alter_column(u'squiiid_squiiidimage', 'image', self.gf('django.db.models.fields.files.FileField')(max_length=100))
